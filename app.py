...
@app.route('/')
def home():
    return render_template('index.html')  # Render a homepage with options

@app.route('/about')
def about():
    return render_template('about.html') # Render a about page with options

@app.route('/lab')
def lab():
    return render_template('home.html') # Render a lab page with options
